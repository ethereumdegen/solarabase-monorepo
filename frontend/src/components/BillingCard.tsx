...
export function BillingCard() {
  ...
  return (
    <div className="bg-[#111] border border-white/5 rounded-xl p-6">
      <h2 className="text-sm font-medium text-white/40 uppercase tracking-wider mb-4">Billing</h2>
      ...
      <div className="grid grid-cols-4 gap-3 text-sm mb-6 text-white/60">
        <div><span className="text-white/25 text-xs block">KBs</span>{limits.kbs}</div>
